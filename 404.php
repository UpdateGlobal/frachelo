...
<html lang="en">
	...
	<!-- Title -->
		<title>Page not Found - True Story - Responsive HTML5 Website</title>
	...
	<!-- MAIN WRAP -->
		<div id="main-wrap">
			...
			<div id="page" class="layout-center page-404">
				<div id="page-content">
					<div id="content">
						...
						<div class="text-center">
							...
							<h3 class="light color">Page not Found</h3>
							
							<p>
							Ooops ... it looks like the page you were looking for has been moved, doesn't exist anymore or is temporarily unavailable.
							<br />
							Try using the search box at the bottom of this page to find what you were looking for, or <a href="#">return to our home page</a>.
							</p>
							
							<div class="divider line"></div>
							
							<form class="search-form" />
								<input type="text" data-prompt="Search ..." />
								<button type="submit" class="small"><i class="small search icon"></i></button>
							</form>
						</div>
